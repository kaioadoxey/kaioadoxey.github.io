...
$( "#searchResults" ).click(function(getData) {
  ...
  function getData(input){
    $.ajax({
         url : "https://api.wunderground.com/api/93d74225031c8694/geolookup/conditions/forecast/hourly/satellite/q/" + input + ".json",
  dataType : "jsonp",
...
$("#searchResults").on("click", "a", function (evt) {
  ...
  $.ajax({
    url: "https://api.wunderground.com/api/93d74225031c8694/geolookup/conditions/forecast/hourly/satellite/q/" + jsonCity + ".json"
    , dataType: "jsonp"
    , success: function (data) {
      console.log(data);
